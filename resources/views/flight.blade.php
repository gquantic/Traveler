                                ...
                                <form action="{{ route('make-road') }}" method="post">
                                    ...
                                    <div class="rt-radio-group">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            ...
                                            <label class="custom-control-label" for="customRadioInline1">Прямой рейс</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline2" name="customRadioInline2"
                                                   class="custom-control-input">
                                            <label class="custom-control-label"
                                                   for="customRadioInline2">С пересадкой</label>
                                        </div>
                                    ...
                                    <div class="rt-input-group">
                                        <div class="single-input  col-rt-in-3">
                                            <select class="rt-selectactive banner-select" name="from"
                                                    style="width: 100%">
                                                {{ $cityController->exportCities($data[0]) }}
                                            </select>
                                            <span class="input-iconbadge"><img
                                                    src="/images/icons-image/s_icon_1.png" alt=""
                                                    draggable="false"></span>
                                        </div><!-- /.single-input -->
                                        <div class="single-input  col-rt-in-3">
                                            <select class="rt-selectactive banner-select" name="to" style="width: 100%">
                                                {{ $cityController->exportCities($data[1]) }}
                                            </select>
                                            <span class="input-iconbadge"><img
                                                    src="/images/icons-image/s_icon_2.png" alt=""
                                                    draggable="false"></span>
                                        </div><!-- /.single-input -->
                                        <div class="single-input  col-rt-in-3">
                                            <input type="text" class="form-control rt-date-picker has-icon"
                                                   placeholder="Когда" value="{{ str_replace('-', '/', $data[2])  }}" name="depart">
                                            <span class="input-iconbadge"><i class="icofont-ui-calendar"></i></span>
                                        </div><!-- /.single-input -->
                                        <div class="single-input  col-rt-in-3">
                                            <input type="text" class="form-control rt-date-picker has-icon"
                                                   placeholder="Обратно" value="{{ str_replace('-', '/', $data[3])  }}" name="return">
                                            <span class="input-iconbadge"><i class="icofont-ui-calendar"></i></span>
                                        </div><!-- /.single-input -->
